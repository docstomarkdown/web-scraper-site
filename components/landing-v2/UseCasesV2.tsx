            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-slate-700 mb-6 tracking-tight">
                        Built for{" "}
                        <span className="text-blue-600">E-commerce Growth</span>
                    </h2>

                    <p className="text-lg text-slate-500 leading-relaxed">
                        Everything you need to stay competitive in the fast-paced
                        world of e-commerce. Turn raw web data into actionable
                    ...
                    {useCases.map((useCase, i) => {
                        ...
                        return (
                            <motion.div
                                key={i}
                                variants={fadeUpVariant}
                                className={`group relative p-8 rounded-2xl bg-white border border-slate-100 ring-2 ring-transparent overflow-hidden cursor-default transition-all duration-300 hover:-translate-y-2 hover:border-slate-200 hover:shadow-2xl ${useCase.glow} ${useCase.ring}`}
                            >
                                {/* Radial color glow — top-right corner */}
                                ...
                                <p className="relative z-10 text-slate-500 leading-relaxed mb-6">
                                    {useCase.description}
                                </p>
