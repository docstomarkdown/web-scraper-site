...
const TermsOfServicePage = () => {
  const markdownFilePath = path.join(process.cwd(), 'content', 'legal', 'terms-of-service.md');
          ...
          <div className="flex-1 ">
            <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-white overflow-hidden">
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-slate-200 px-6 py-8">
                <h1 className="text-3xl font-heading text-slate-800">Terms Of Service</h1>
              </div>
              ...
              <div className="p-6 sm:p-8 lg:p-10">
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    p: ({ node, ...props }) => (
                      <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4 mt-5" {...props} />
                    ),
                    ul: ({ node, ...props }) => (
