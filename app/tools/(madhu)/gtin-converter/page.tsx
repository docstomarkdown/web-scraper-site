...
import { HelpCircle, RefreshCw, Calculator, BookOpen, ScanLine, ShieldCheck } from "lucide-react"
import { FadeIn, ToolFAQ } from "@/app/tools/_shared/components"
import { CTA } from "@/components/sections/CTA"

export const metadata: Metadata = {
    title: "GTIN Converter - UPC, EAN, GTIN-12, GTIN-13, GTIN-14",
                    ...
                    <FadeIn delay={0.1}>
                        <section id="how-to-use" className="relative">
                            <div className="flex items-center gap-3 mb-10 pb-4 border-b border-slate-200">
                                ...
                                <h2 className="text-2xl font-bold text-slate-900">How to Use This Converter</h2>
                            </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Enter, Scan, or Upload</h3>
                                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                                Type your barcode manually, use your <b>camera to scan</b>, or upload a product image. Supports UPC-A, EAN-13, and GTIN-14 formats.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-blue-50/40 p-5 sm:p-6 rounded-2xl border-2 border-blue-200 shadow-sm shadow-blue-100/20 hover:shadow-md hover:shadow-blue-200/25 transition-all duration-300 scale-[1.02] origin-left">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Get All Formats</h3>
                    ...
                    <FadeIn delay={0.2}>
                        <ToolFAQ
                            faqs={[
                                ...
                                {
                                    question: "When should I use GTIN-14?",
