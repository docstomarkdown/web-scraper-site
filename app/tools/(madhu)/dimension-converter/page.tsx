...
import { Counter } from "../../_shared/components/Counter"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            <div className="lg:col-span-7">
                                <Card className="border border-slate-200 shadow-sm bg-white overflow-hidden h-full flex flex-col">
                                    ...
                                    <CardContent className="space-y-6 pt-6 flex-1 flex flex-col">
                                        ...
                                        <Button
                                            variant="outline"
                                            className="w-full h-11 border-dashed hover:bg-slate-50 text-slate-500 hover:text-slate-900 transition-all mt-auto font-bold"
                                            onClick={clearAll}
                                        >
                            ...
                            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-8">
                                <FadeIn delay={0.4} direction="left" className="space-y-6">
                                    ...
                                    {converted && (
                                        <Button onClick={copyToClipboard} variant="outline" className="w-full h-12 shadow-sm border-slate-200 hover:bg-slate-50 transition-all font-bold text-blue-600">
