...
const toolDescriptions: Record<string, string> = {
    ...
    "UPC/EAN Validator": "Validate UPC, EAN, and ISBN barcodes to ensure product compliance and data accuracy.",
    "GTIN Converter": "Convert between GTIN-8, GTIN-12, GTIN-13, and GTIN-14 formats for global compatibility.",
    "Break-Even Calculator": "Determine the sales volume needed to cover costs and start generating profit.",
    "ROAS Calculator": "Calculate Return on Ad Spend to measure the effectiveness of your digital advertising campaigns.",
    ...
    "MOQ Cost Calculator": "Calculate the total cost and per-unit cost when purchasing Minimum Order Quantities.",
    ...
    "PPC Bid Calculator": "Calculate the maximum CPC bid you should pay to achieve your target ACoS.",
    "ACoS Calculator": "Calculate Advertising Cost of Sales to measure the efficiency of your Amazon PPC campaigns.",
    "TACoS Calculator": "Calculate Total Advertising Cost of Sales to see the holistic impact of ads on your business.",
    "Ad Spend Budget Planner": "Plan your advertising budget based on your revenue goals and target ACoS.",
    "Return Rate Calculator": "Calculate your product return rate to identify quality issues and improve customer satisfaction.",
    "CLV Calculator": "Calculate Customer Lifetime Value to understand how much a customer is worth to your business over time.",
