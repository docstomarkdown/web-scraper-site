...
export const metadata: Metadata = {
    title: 'ROI Calculator - Measure Product Return on Investment | Web Scraper Pro',
    description: 'Free ROI calculator to instantly measure return on investment for any product. Calculate net profit, ROI percentage, and profit ratio. Essential for e-commerce sellers.',
}
                    ...
                    <FadeIn delay={0.2}>
                        <ToolFAQ
                            faqs={[
                                ...
                                {
                                    question: "What is a good ROI for e-commerce?",
                                ...
                                {
                                    question: "How is Monthly ROI calculated?",
