...
import { MousePointerClick, CircleDollarSign, TrendingUp, BarChart3 } from "lucide-react"
                ...
                <div className="space-y-6">
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Enter Investment</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                Input the total amount you invested — including product cost, shipping, ads, and any other expenses.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Add Revenue</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                Enter the total revenue you generated from sales of the product.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">See Your ROI</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                View your ROI percentage, net profit, and profit-to-investment ratio instantly.
                            </p>
                        </div>
                    </div>
                </div>
