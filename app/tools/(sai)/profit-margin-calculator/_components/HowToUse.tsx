...
import { MousePointerClick, CircleDollarSign, Calculator, TrendingUp } from "lucide-react"
                ...
                <div className="space-y-6">
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Enter Cost & Price</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                Input your buying price (Cost) and your selling price (Revenue). This is the foundation of your margin analysis.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">View Margins</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                The calculator instantly shows your Gross Margin % and Markup %. Understanding the difference is key to profitability.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Analyze Profit</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                See your exact profit per unit. Use this to determine if your pricing strategy covers your overhead and desired profit.
                            </p>
                        </div>
                    </div>
                </div>
