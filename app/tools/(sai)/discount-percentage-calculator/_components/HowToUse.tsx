                ...
                <div className="space-y-6">
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Enter Price & Discount</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                Input the original price of the item and the discount percentage you want to apply.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Check Savings</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                The calculator immediately shows you exactly how much money you are saving.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start gap-4 sm:gap-8 group bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">See Final Price</h3>
                            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                                View the final discounted price you will pay after the reduction is applied.
                            </p>
                        </div>
                    </div>
                </div>
